...
export async function main(ns) {
  ...
  ns.tprint("Security: " + ns.getServerMinSecurityLevel(target) + "/" + ns.getServerSecurityLevel(target));
  ...
  if (ns.getServerMaxMoney(target) != 0) {
    ns.tprint("Money: " + moneyDollars + " / " + moneyMaxDollars + " (" + Math.floor(moneyRaw / moneyMaxRaw * 100) + "%)");
  } else {
